...
BR-CUS-07 & Nhận voucher đã mua & Hoàn thành & \texttt{MyVouchersPage.jsx}, \texttt{user.controller.js} (\texttt{getMyVouchers}), \texttt{issued\_vouchers} & Xem code sau PAID; QR mô phỏng trên UI & —\\
